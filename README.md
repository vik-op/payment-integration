...
📦 Installation & Setup
Clone the repo: git clone https://github.com/your-username/payment-integration-demo

Environment: Copy .env.example to .env and add your Gateway Secret Keys.

Mocking Webhooks: Use ngrok to tunnel your local environment for testing webhook notifications.
